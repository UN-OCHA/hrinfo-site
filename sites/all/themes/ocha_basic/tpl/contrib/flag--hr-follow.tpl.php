...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> btn btn-primary btn-lg" rel="nofollow"><?php print $link_text; ?> <i class="fa <?php $action == 'flag' ? print 'fa-random' : print 'fa-times'; ?>"></i></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
